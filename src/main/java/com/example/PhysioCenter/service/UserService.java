...
public interface UserService {
    UserDto createPatientUser(CreatePatientUserDto createPatientUserDto) throws PatientNotCreatedException, UserNotCreatedException, AuthDataDuplicatedException;
}
